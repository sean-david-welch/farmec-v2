...
func WarrantyControllerTest(test *testing.T) (*gin.Engine, *mocks.MockWarrantyService, *handlers.WarrantyController, *httptest.ResponseRecorder, time.Time) {
	...
	controller := handlers.NewWarrantyController(mockService)
