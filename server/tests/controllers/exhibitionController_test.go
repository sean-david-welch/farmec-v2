...
func ExhibitionControllerTest(test *testing.T) (*gin.Engine, *mocks.MockExhibitionService, *handlers.ExhibitionController, *httptest.ResponseRecorder, time.Time) {
	...
	controller := handlers.NewExhibitionController(mockService)
