...
func EmployeeControllerTest(test *testing.T) (*gin.Engine, *mocks.MockEmployeeService, *handlers.EmployeeController, *httptest.ResponseRecorder, time.Time) {
	...
	controller := handlers.NewEmployeeController(mockService)
